...
public class AbsoluteDriveAdv extends Command
{
  ...
  private final BooleanSupplier lookAway, lookTowards, lookLeft, lookRight, lookHalfLeft, lookHalfRight;
  ...
  public AbsoluteDriveAdv(SwerveSubsystem swerve, DoubleSupplier vX, DoubleSupplier vY, DoubleSupplier headingAdjust,
                          ...
                          BooleanSupplier lookRight,BooleanSupplier lookHalfLeft, BooleanSupplier lookHalfRight)
  {
    this.swerve = swerve;
    this.vX = vX;
    this.vY = vY;
    ...
    this.lookHalfLeft = lookHalfLeft;
    this.lookHalfRight = lookHalfRight;
  ...
  public void execute()
  {
    ...
    //makes the robot go to a 120 degree angle.
    if(lookHalfLeft.getAsBoolean())
    {
      headingX = 0.67;
      headingY = 0.33;
    }
    // makes the robot go to a 60 degree angle.
    if (lookHalfRight.getAsBoolean())
    {
      headingX = -0.67;
      headingY = 0.33;
    }
